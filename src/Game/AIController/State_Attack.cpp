...
fsm::FSM_Command State_Attack::OnRun()
{
	...
	else
	{
		...
		if (facingTarget)
		{
			data->character->createBullet(new Bullet("Bullet", data->loader->get_Mesh3D("7"), data->character, data->loader->get_Texture("24"), data->loader->get_Texture("7")), data->loader->get_Sound("2"));
		}
	}
